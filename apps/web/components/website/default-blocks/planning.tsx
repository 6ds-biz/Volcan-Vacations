...
export function PlanningHero(config:Editorial={}){return editorial((<PageHero eyebrow="Start with your travel style" title="What would make this trip feel like yours?" intro="Tell us what you’re drawn to. This early planning worksheet will help shape the future personalized trip-planning experience." />),config);}
export function PlanningContent(config:Editorial={}){return editorial((<section className="section planner-section"><Container className="planner-layout">
...
export function PlanningIntro(config:Editorial={}){return editorial((<aside className="planner-aside"><p className="eyebrow">A simple beginning</p><h2>There is no wrong way to experience Costa Rica.</h2><p>Choose whatever sounds most like you. Your answers are not submitted or saved yet.</p><ol><li><span>1</span>Your group</li><li><span>2</span>Your travel style</li><li><span>3</span>Your interests</li><li><span>4</span>Contact details</li></ol></aside>),config);}
