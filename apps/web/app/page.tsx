...
export default function Home() {
  return (
    <main id="main-content" className="home-page">
      ...
      {/* Arenal is one continuous rainforest chapter, separate from the coast below. */}
      <section className="home-journey" aria-labelledby="arenal-title">
      ...
      <section className="home-featured home-ivory" aria-labelledby="featured-title">
        <Container>
      ...
      <section className="benefits-section home-ivory" aria-label="The Volcan Vacations difference">
      ...
      <section className="home-trip-planning home-ivory" aria-labelledby="planning-title">
      ...
      <section className="home-pacific" aria-labelledby="pacific-title">
      ...
      <section id="coastal-destinations" className="home-coastal-destinations home-ivory" aria-labelledby="coastal-title">
        <Container>
